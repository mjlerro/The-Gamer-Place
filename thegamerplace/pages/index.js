...
export default function Home() {
  return (
    <>
      ...
      <Container className="d-flex flex-column justify-content-center align-items-center" style={{ paddingTop: "8vmin", paddingBottom: "2.5vmin", backgroundColor: "black" }}>
        <Row style={{ color: "white", fontSize: "8vmin", textAlign: "center" }}>The Gamer Place</Row>
        <Row style={{ color: "white", fontSize: "3vmin", textAlign: "center" }}>A Hub for All Gamers</Row>
      </Container>
      <Container className="bg-light">
        <Row>
          <Col sm={5}>
            <Image src="/controller.png" width="100%" className="img-responsive"></Image>
          </Col>
          <Col sm={7} style={{ fontSize: "2.5vmin", paddingLeft: "3vmin", paddingRight: "3vmin", paddingTop: "3vmin", fontFamily: "helvetica", textAlign: "center" }} className="d-flex flex-column justify-content-center align-items-center">
            <div style={{ paddingBottom: "10vmin" }}>The Gamer Place is a community of people who... well play video games! Feel free to talk about anything in our forums and check out some of our game reviews.</div>
            <Link href="/login">
              <Button variant="dark" size="lg" style={{ width: "20vmin" }}>Login</Button>
            </Link>
          </Col>
        </Row>
      </Container>
      <Container className="bg-light" style={{ paddingBottom: "10vmin" }}>
        <Row style={{ paddingTop: "15vmin" }}>
          <Col sm={3} style={{ paddingTop: "10vmin", paddingBottom: "8vmin", fontSize: "3vmin" }} className="d-flex flex-column justify-content-center align-items-center">
            Our Supporters:
          </Col>
